...
WORKDIR /home/eduardo/Dropbox/dev/edware2025/
...
# By specifying the "8.2.17-apache" tag, it will also use whatever happens to be the
# most recent version of that tag when you build your Dockerfile.
# If reproducability is important, consider using a specific digest SHA, like
# php@sha256:99cede493dfd88720b610eb8077c8688d3cca50003d76d1d539b0efc8cca72b4.
FROM php:8.2.17-apache AS final
...
COPY --from=deps /home/eduardo/Dropbox/dev/edware2025/vendor/ /var/www/html/vendor
